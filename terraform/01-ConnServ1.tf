resource "vsphere_virtual_machine" "_ConnServ1" {
  name                 = var.ConnServ1_name
  ...
  num_cpus  = var.ConnServ1_cpu_num
  memory    = var.ConnServ1_mem
  ...
  clone {
    ...
    customize {
      windows_options {
        computer_name    = var.ConnServ1_name
