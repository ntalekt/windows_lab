resource "vsphere_virtual_machine" "_ConnServ2" {
  name                 = var.ConnServ2_name
  ...
  num_cpus  = var.ConnServ2_cpu_num
  memory    = var.ConnServ2_mem
  ...
  clone {
    ...
    customize {
      windows_options {
        computer_name    = var.ConnServ2_name
